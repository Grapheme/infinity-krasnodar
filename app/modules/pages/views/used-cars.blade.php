    ...
    <section class="buy-offer used inf-block">
        ...
        @if(count($products))
            <div class="cars-filter">
                @if (0)
                    <select name="model" class="customSelect selectModel filterSelectModel"
                            data-filter-object-selector=".sub-offers-ul">
                ...
                @endif
                <select name="year" class="customSelect selectYear filterSelectYear"
                        data-filter-object-selector=".sub-offers-ul">
