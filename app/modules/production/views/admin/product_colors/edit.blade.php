...
{{ Form::model($color, array('url'=>URL::route('product_color_update',array('product_id'=>$product->id,'color_id'=>$color->id)), 'class'=>'smart-form', 'id'=>'product-color-form', 'role'=>'form', 'method'=>'post')) }}
    <div class="row margin-top-10">
        <section class="col col-6">
            <div class="well">
                <header>Для изменения цвета продукта отредактируйте форму:</header>
                <fieldset>
                    <section>
                    ...
                    <section>
                        ...
                        <label class="input">
                            {{ ExtForm::image('image', $color->images)}}
                        </label>
                    </section>
                    @endif
                </fieldset>
