...
@stop
@section('content')
    <h1>Добавить автомобиль в наличии - {{ $product->meta->first()->title }}</h1>
{{ Form::open(array('url'=>URL::route('instock.store',array('product_id'=>$product->id)), 'role'=>'form', 'class'=>'smart-form', 'id'=>'product-instock-form', 'method'=>'post')) }}
    <div class="row margin-top-10">
        <section class="col col-6">
            <div class="well">
                <header>Для добавления автомобиля в наличии заполните форму:</header>
                <fieldset>
